#!/bin/bash
# run_clas_persona.sh — trains + evaluates CLAS on SELF-generated
# completions (both short_instructed_cut and long_subsampled_anchor),
# for all 6 persona concepts. Completes the comparison table alongside
# the teacher-completion run (run_clas_persona_teacher.sh) -- before
# this, CLAS had only been tried with teacher completions.
#
# Add-on script -- reuses already-computed baseline_directions.pkl and
# each strategy's dataset_with_completions.json from run_personas.sh +
# run_completion_strategies.sh. Does NOT re-run or touch that work.
#
...
# # ===============================
# # STRATEGY 1: short_instructed_cut
# # ===============================
# echo ""
# echo "############################################################"
# echo "# CLAS 1/2 (SELF): short_instructed_cut"
# echo "############################################################"
# python $CODE_DIR/train_and_evaluate_clas.py \
#     --concept_type            persona \
#     --manifest_path            $DATA_DIR/personas/manifest.json \
#     --model                    $MODEL \
#     --output_dir                $OUT_DIR/$MODEL_TAG \
#     --source_strategy_dir       short_instructed_cut \
#     --cache_dir                 $CACHE_DIR \
#     --val_frac                  $VAL_FRAC \
#     --lr_weight                 $LR_WEIGHT \
#     --lr_bias                   $LR_BIAS \
...
# ===============================
# STRATEGY 2: long_subsampled_anchor
# ===============================
echo ""
echo "############################################################"
...
echo "  outputs/\$MODEL_TAG/persona_<name>/clas_short_instructed_cut/summary.csv"
echo "  outputs/\$MODEL_TAG/persona_<name>/clas_long_subsampled_anchor/summary.csv"
echo "Combined:"
...
echo "Existing teacher results (run_clas_persona_teacher.sh) are untouched -- different output folder."